 ...
 * FIX: Added service worker registration for /ogchats/ subdirectory
 */
...
if ('serviceWorker' in navigator) {
  window.addEventListener('load', () => {
    ...
    navigator.serviceWorker.register('/ogchats/sw.js', { scope: '/ogchats/' })
      .then(registration => {
    ...
    // Auto-reload would disrupt users mid-conversation.
    // The update notification banner (above) lets users choose when to refresh.
  });
}
...
// pwaAPI: minimal public surface — SW communication is handled by notifications.js
window.pwaAPI = {
  isInstalled: () =>
